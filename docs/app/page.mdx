...
- Why can't it play automatically in the browser sometimes ?
  - see [browser autoplay policy](https://developer.chrome.com/blog/autoplay)

## CDN

[unpkg](https://app.unpkg.com/twist-aplayer)
